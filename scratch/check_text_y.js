...
// Print rows with high density of dark pixels (indicating text)
let inText = false;
let startY = 0;
let maxDark = 0;
...
if (inText) {
  console.log(`Text row: uy [${startY.toFixed(1)} - 830.0] (Max dark pixels: ${maxDark})`);
}
